  ...
  const products = useRef([
    {
      ...
      description:
        "Known for her sculptural takes on traditional tailoring, Australianarbiter of cool Kym Ellery teams up with Moda Operandi.",
      price: 52,
      image: "../img/box/1.svg",
      size:'S'
    },
        ...
        <>
          <div className="product" key={index}>
            ...
            <div className="product__content">
              <button  className="product__name">
                {product.name}
              </button>
